...
int16_t Pitch=0, Roll=0, Heading=0, rotation_fix = 0, Last_Heading;
...
int already_shooted = 0, shoot_cnt = 0, mf_cnt = 0, stop_before_shoot_cnt = 0, out_cnt, goalkeeper_cnt = 0, comeback_cnt = 0;
#define LDR_Sens 200
char look_dir = 'F';
char* robotID;
int last_ball_x , last_ball_y, Last_Time;
int ball_move_dist;
int goal_keeper_y, behind_ball_y;
int shl, shr, shb;
float K_P, K_I, K_D, GY;
