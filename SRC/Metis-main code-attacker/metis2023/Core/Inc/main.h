...
#define L2A_Pin GPIO_PIN_7
#define L2A_GPIO_Port GPIOE
#define L1A_Pin GPIO_PIN_8
#define L1A_GPIO_Port GPIOE
#define L1B_Pin GPIO_PIN_10
#define L1B_GPIO_Port GPIOE
#define L2B_Pin GPIO_PIN_12
...
extern int16_t Pitch, Roll, Heading, rotation_fix;
extern int v;
extern int ball_angle , ball_dist, is_ball;
extern int goal_angle , goal_dist, is_goal;
extern void read_sensors();
extern int already_shooted, shoot_cnt, mf_cnt, stop_before_shoot_cnt, kaf[16];
extern int arrived_to_goal;
extern char look_dir;
extern int ball_in_kicker;
#define LDR_Sens 200
